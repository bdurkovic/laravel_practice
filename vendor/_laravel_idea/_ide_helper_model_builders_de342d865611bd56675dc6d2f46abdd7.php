<?php //9dc63910d9ed0aeefc39da974144a6b3
/** @noinspection all */
...
namespace LaravelIdea\Helper {
     ...
     * @method $this whereNotMorphedTo($relation, Model|string $model, $boolean = 'and')
     ...
     * @method $this orWhereMorphedTo($relation, Model|null|string $model)
     ...
     * @method $this whereMorphedTo($relation, Model|null|string $model, $boolean = 'and')
     ...
     * @method $this orWhereNotMorphedTo($relation, Model|string $model)
